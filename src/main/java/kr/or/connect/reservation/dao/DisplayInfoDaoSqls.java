...
public class DisplayInfoDaoSqls {
	final static String SELECT_DISPLAY_INFO_BY_ID = "SELECT product_id id, category_id, display_info_id, name, description, content, event, opening_hours, place_name, place_lot, place_street, tel, homepage, email, create_date, modify_date, file_id FROM "
